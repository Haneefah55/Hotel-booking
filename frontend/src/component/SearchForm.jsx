...
const SearchForm = () =>{
  ...
  return(
    <div className=" mt-10 ">
      <form className="flex flex-col md:flex-row bg-gray-200 w-full md:w-[850px] text-amber-900 rounded-md shadow-md justify-between  md:backdrop-blur-lg text-md p-5">
        ...
        <div className=" flex flex-col w-full md:w-[120px] mr-5 gap-4 mb-5">
        ...
        <button type="submit" className="p-3 bg-amber-800 w-[110px] flex items-center justify-center gap-2 md:self-center text-gray-100 font-semibold hover:bg-transparent hover:text-amber-800 hover:border-2 hover:border-amber-800">
          <Search />
          Search
        </button>
